...
//Declaring variables
        Genre = (EditText) view.findViewById(R.id.txt_Profile_Genre);
        FullName = (EditText) view.findViewById(R.id.txt_Profile_Fullname);
        Book = (EditText) view.findViewById(R.id.txt_Profile_Book);
